      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="mb-32">
          <video
            ...
            controls
            poster="/ToolWebSite/v1_screens/v1_home_screen.png"
          >
            <source src="/ToolWebSite/v1_screens/v1_show.mp4" type="video/mp4" />
          </video>
        </div>
        ...
        <div className="mb-32 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <Image
              src="/ToolWebSite/v1_screens/v1_main_screen.png"
              alt="Light Mode"
              width={1400}
              height={900}
            ...
            />
            <Image
              src="/ToolWebSite/v1_screens/v1_main_screen_dark.png"
              alt="Dark Mode"
              width={1400}
              height={900}
              className="rounded-2xl shadow-xl w-full"
        ...
        <div className="space-y-32">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-8">
              <Image
                src="/ToolWebSite/v1_screens/v1_changed_files_screen.png"
              ...
              />
              <Image
                src="/ToolWebSite/v1_screens/v1_changed_files_screen_dark.png"
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-8">
              <Image
                src="/ToolWebSite/v1_screens/v1_search_screen.png"
              ...
              />
              <Image
                src="/ToolWebSite/v1_screens/v1_search_screen_dark.png"
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-8">
              <Image
                src="/ToolWebSite/v1_screens/v1_diff_screen.png"
                alt="Code Diff - Light"
                width={1400}
                height={900}
                className="rounded-2xl shadow-xl w-full"
              />
              <Image
                src="/ToolWebSite/v1_screens/v1_diff_screen_dark.png"
                alt="Code Diff - Dark"
                width={1400}
                height={900}
                className="rounded-2xl shadow-xl w-full"
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-8">
              <Image
                src="/ToolWebSite/v1_screens/v1_privacy_screen.png"
              ...
              />
              <Image
                src="/ToolWebSite/v1_screens/v1_privacy_screen_dark.png"
          ...
          <div className="space-y-6">
            ...
            <div className="mb-32">
              <video
                ...
                poster="/ToolWebSite/v1_screens/v1_home_screen.png"
              >
                <source src="/ToolWebSite/v1_screens/v1_shortcuts_demo.mp4" type="video/mp4" />
              </video>
            </div>
